...
#define RTT_KERNAL_ONLY         (0) /*只内核配置*/
...
#define RT_TICK_PER_SECOND 1000			//定义时钟节拍，为1000时表示1000个tick每秒，一个tick为1ms
...
#define RT_USING_UART1					//定义该宏开启UART1的使用
//#define RT_SERIAL_USING_DMA				//定义该宏开启串口DMA的使用
...
#define FINSH_THREAD_PRIORITY       (RT_THREAD_PRIORITY_MAX*6/10)/*定义shell线程的优先级为当前最大优先级的60%*/
#define FINSH_THREAD_STACK_SIZE 1024	//开启系统FinSH时：定义该线程的栈大小
...
/* BSP配置 */
#define BSP_USING_KEY					//定义该宏开启按键的使用 
#define BSP_USING_LED					//定义该宏开启LED的使用
